...
const Myself = () => {
  ...
  return (
    <div
      id="mySelf"
      className="  max-h-screen w-[100%] mt-[20%] lg:mt-[3%]  lg:h-screen flex justify-center"
    >
      {" "}
      <div className=" container mx-auto flex flex-col justify-center lg:flex-row-reverse lg:items-center">
